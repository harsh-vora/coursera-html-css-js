...
import Artwork, { PolymorphicArtwork } from 'types/Artwork';
...
export const buildModelPosterImageUrl = (artwork: Artwork): string => {
...
export const buildPosterUrl = cond([
  [(artwork) => isModel(artwork.assetIPFSPath), buildModelPosterImageUrl],
...
export const buildArtworkAssetUrl = curry(
  (options: AssetOptions, artwork: PolymorphicArtwork) =>
    cond([
