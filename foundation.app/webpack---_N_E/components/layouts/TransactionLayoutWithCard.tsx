...
import useNavigationStep from 'hooks/use-navigation-step';
...
export default function TransactionLayoutWithCard(
  ...
  const { children, title, buildTitle, currentStep, navigationSteps } = props;
...
export function WrappedTransactionLayoutWithCard(
  ...
  const { title, buildTitle, currentStep, navigationSteps } = props;
