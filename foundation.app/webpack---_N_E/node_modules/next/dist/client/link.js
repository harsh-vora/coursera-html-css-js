...
function prefetch(router, href, as, options) {
    ...
    router.prefetch(href, as, options).catch(err => {
        if (process.env.NODE_ENV !== 'production') { // rethrow to show invalid URL errors
            throw err;
        }
    });
...
function linkClicked(e, router, href, as, replace, shallow, scroll, locale) {
    ...
    if (nodeName === 'A' && (isModifiedEvent(e) || !(0, _router.isLocalURL)(href))) { // ignore click for browser’s default behavior
        return;
    }
...
function Link(props) {
    if (process.env.NODE_ENV !== 'production') {
        ...
        requiredProps.forEach(key => {
            ...
            } else { // TypeScript trick for type-guarding:
