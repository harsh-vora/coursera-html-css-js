...
function RouteAnnouncer() {
    ...
    const [routeAnnouncement, setRouteAnnouncement] = (0, _react.useState)(''); // Only announce the path change, but not for the first load because screen reader will do that automatically.
    ...
    return /*#__PURE__*/ _react.default.createElement("p", {
        ...
        style: {
            ...
            padding: 0,
            position: 'absolute',
            width: '1px', // https://medium.com/@jessebeach/beware-smushed-off-screen-accessible-text-5952a4c2cbfe
            whiteSpace: 'nowrap',
            wordWrap: 'normal'
        }
    }, routeAnnouncement);
