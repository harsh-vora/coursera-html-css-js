...
function onReport(metric) {
    ...
    if (process.env.NODE_ENV === 'production' && // This field is empty unless you explicitly configure it:
        ...
        const blob = new Blob([new URLSearchParams(body).toString()], { // This content type is necessary for `sendBeacon`:
...
var _default = onPerfEntry => { // Update function if it changes:
