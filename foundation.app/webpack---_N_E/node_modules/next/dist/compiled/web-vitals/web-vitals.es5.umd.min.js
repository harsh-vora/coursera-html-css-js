            ...
            ! function(t, n) {
                ...
                var e, n, i = function() {
                    ...
                    p = function(t) {
                        ...
                        u || (c(), u = !0), addEventListener("visibilitychange", function(e) {
                            var n = e.timeStamp;
                    ...
                    f = function() {
                        return void 0 === e && (e = "hidden" === document.visibilityState ? 0 : 1 / 0, p(function(t) {
                            var n = t.timeStamp;
                            return e = n
                        }, !0)), {
                            get timeStamp() {
                ...
                t.getCLS = function(t) {
                    ...
                    var e = a("FID"),
                        n = f(),
                        i = function(t) {
                            t.startTime < n.timeStamp && (e.value = t.processingStart - t.startTime, e.entries.push(t), e.isFinal = !0, u())
                        },
                        o = r("first-input", i),
                        u = l(t, e, o);
                    o ? p(function() {
